...
export const constantRoutes = [
  ...
  // },
  {
    path: '/MarketVisualization',
    component: Layout,
    children: [
      {
        path: 'index',
        name: 'MarketVisualization',
        component: () => import('@/views/MarketVisualization/index'),
        meta: { title: 'MarketVisualization', icon: 'form' }
      }
    ]
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      // {
      //   path: 'single',
      //   component: () => import('@/views/Forecast/single/index'), // Parent router-view
      //   name: 'single',
      //   meta: { title: 'single' }
      // },
      // {
      //   path: 'multiple',
      //   component: () => import('@/views/Forecast/multiple/index'), // Parent router-view
      //   name: 'multiple',
      //   meta: { title: 'multiple' }
      // }
    ]
